...
customElements.define(
	...
	class extends HTMLElement {
		constructor( content = '', done = false ) {
			...
			this.innerHTML = `
				<span class="prpl-move-buttons" style="padding: 0 0.5em;">
				...
				<span
					class="content"
					style="font-size: 1rem; padding: 0; margin-top: 2px; margin-left: 1em; margin-right: 0.5em; width: 100%; display: border-box; border-bottom: 1.5px solid transparent;"
